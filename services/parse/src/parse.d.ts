...
declare namespace Parse {
  ...
  class GeoPoint {
    ...
    constructor(
      coords?: { latitude: number; longitude: number } | [number, number]
    );
  ...
  interface Object<T extends Attributes = Attributes> {
    ...
    addAll<
      K extends { [K in keyof T]: T[K] extends any[] ? K : never }[keyof T]
    >(
      attr: K,
      items: T[K]
    ): this | false;
  ...
  interface ObjectStatic {
    ...
    registerSubclass<T extends Object>(
      className: string,
  ...
  class Query<T extends Object = Object> {
    ...
    addAscending<K extends keyof T["attributes"] | keyof BaseAttributes>(
      key: K | K[]
    ): this;
    addDescending<K extends keyof T["attributes"] | keyof BaseAttributes>(
      key: K | K[]
    ): this;
    ...
    doesNotExist<K extends keyof T["attributes"] | keyof BaseAttributes>(
      key: K
    ): this;
    ...
    equalTo<K extends keyof T["attributes"] | keyof BaseAttributes>(
      ...
      value:
        | T["attributes"][K]
        | (T["attributes"][K] extends Object ? Pointer : never)
    ): this;
  ...
  namespace Cloud {
    ...
    function afterDelete(
      arg1: any,
      func?: (request: AfterDeleteRequest) => Promise<void> | void
    ): void;
    function afterSave(
      arg1: any,
      func?: (request: AfterSaveRequest) => Promise<void> | void
    ): void;
    function beforeDelete(
      arg1: any,
      func?: (request: BeforeDeleteRequest) => Promise<void> | void
    ): void;
    function beforeSave(
      arg1: any,
      func?: (request: BeforeSaveRequest) => Promise<void> | void
    ): void;
    function beforeFind(
      arg1: any,
      func?: (
        request: BeforeFindRequest
      ) => Promise<Query> | Promise<void> | Query | void
    ): void;
    function afterFind(
      arg1: any,
      func?: (request: AfterFindRequest) => any
    ): void;
